    ...
    <header className="border-2 border-gray-200">
      <div className="container m-auto py-10 px-5  flex items-center justify-between">
        ...
        <nav className="relative">
          ...
          <ul className="absolute right-0 w-[200px] md:w-fit bg-black md:bg-transparent text-white md:text-black p-5 md:static md:flex md:items-center md:gap-5">
            {navLinks.map((link) => (
        ...
        <div className="hidden md:flex md:items-center md:gap-5">
          <div className="flex items-center gap-2 bg-[#f5f5f5] p-3 rounded-md">
            <input type="text" placeholder="What are you looking for?" className="outline-0" />
                ...
                <ul className="flex flex-col gap-3">
                  ...
                  <li>
                    <Link to={"/collections"} className="flex items-center gap-2">
                      <FaRegCircleXmark /> My Collections
                    </Link>
                  </li>
